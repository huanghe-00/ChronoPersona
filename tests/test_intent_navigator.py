...
class TestIntentNavigator:
    ...
    def test_navigate_finds_reachable_nodes(self) -> None:
        ...
        graph = IntentGraph()
        graph.add_concept(Concept("c_food", "食物", "abstract", branch_id="main"), branch_id="main")
        graph.add_concept(Concept("c_sichuan", "川菜", "food", parent_id="c_food", branch_id="main"), branch_id="main")
