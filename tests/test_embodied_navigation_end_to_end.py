...
class TestEmbodiedNavigationEndToEnd:
    ...
    def test_navigation_memory_persisted_to_l2(self, core: StateMachineAgentCore) -> None:
        ...
        # v1.1.0: Provenance chain verification via dedicated fields
        assert nav_memories[0].extraction_model == "heuristic_rule"
        assert nav_memories[0].extraction_confidence == 1.0
